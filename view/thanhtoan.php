                    ...
                    <div class="tab-content">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12">
                                            <div class="booking_next_btn padding-top-30 margin-top-20 clearfix border-top-whitesmoke">
                                                <!-- <a href="index.php?act=ttcanhan&idphong=" class="btn btn-warning btn-sm floatright">Next</a> -->
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div role="tabpanel" id="personal_info">
                            <div class="personal_info_area">
                                <div class="hotel_booking_area">
                                    <h3>Xác nhận thông tin đặt phòng <?= $name ?></h3>
                                    <div class="hotel_booking margin-top-70 margin-bottom-125">
                                        <form role="form" action="index.php?act=datphong" method="post">
                                            ...
                                            <div class="form-group col-lg-3 col-md-3 col-sm-3 icon_arrow">
                                                <div class="input-group">
                                                    Số người<input type="number" name="songuoi" class="form-control" placeholder="">
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="form-group col-lg-3 col-md-3 col-sm-3 icon_arrow">
                                                    <div class="input-group">
                                                        Ngày bắt đầu<input type="date" name="ngaybatdau" class="form-control">
                                                    </div>
                                                </div>
                                                <div class="form-group col-lg-3 col-md-3 col-sm-3 icon_arrow">
                                                    <div class="input-group">
                                                        Ngày kết thúc<input type="date" name="ngayketthuc" class="form-control">
                                                    </div>
                                                </div>
                                            ...
                                            <div class="row">
                                                <div class="col-lg-12 col-md-12">
                                                    <div class="booking_next_btn padding-top-30 margin-top-50 clearfix border-top-whitesmoke">
                                                        <a href="index.php" class="btn btn-warning btn-sm btn-info">Back</a>
